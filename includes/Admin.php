...
class Admin {
	...
	private function do_hooks() {
		...
		add_action( 'init', array($this, 'finance_post_type_init') );
	...
	/**
	 * Register a finance post type.
	 *
	 * @link http://codex.wordpress.org/Function_Reference/register_post_type
	 */
	public function finance_post_type_init() {
		$labels = array(
			'name'               => __( 'Finances' ),
			'singular_name'      => __( 'Finance'),
			'menu_name'          => __( 'Finance'),
			'name_admin_bar'     => __( 'Finance'),
			'add_new'            => __( 'New Finance'),
			'add_new_item'       => __( 'Add New Finance'),
			'new_item'           => __( 'New Finance'),
			'edit_item'          => __( 'Edit Finance'),
			'view_item'          => __( 'View Finance'),
			'all_items'          => __( 'Finance'),
			'search_items'       => __( 'Search Finance'),
